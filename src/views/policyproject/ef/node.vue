<template>
    ...
    >
        ...
        <!-- 节点名称 -->
<!--        <div :class="node.type !== 'JUDGE' ? 'ef-node-text' : 'ef-node-text ef-node-text-judge'" :show-overflow-tooltip="true">-->
...
<script>
    export default {
        ...
        computed: {
            ...
            nodeIcoClass() {
                var nodeIcoClass = {}
                nodeIcoClass[this.node.data.ico] = true
      ...
      methods: {
        contextmenu(e) {
          ...
          this.$emit('handleContextMenu', {node: this.node, x: e.clientX, y: e.clientY})
        },
            // 点击节点
            clickNode() {
